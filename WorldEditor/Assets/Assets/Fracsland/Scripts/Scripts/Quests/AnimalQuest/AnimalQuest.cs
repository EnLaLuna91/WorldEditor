...
public class AnimalQuest : Quest
{
    ...
    public override void Configure(ConfiguredQuest configuration)
    {
        ...
        //GUIController.instance.ShowGoal(UIGoal.GOALTYPE.VIOLENT, Description, PortalManager.GetPortalBySceneName(Constants.SCENE_NAME_FARM), this);
    ...
    public override void Interact(){
        ...
        GameControllerFracsland.instance.ConfiscateItems(Vegetable.GetItemByVegetableType(Plant));
    }
    ...
    public void PlantPlanted(object[] args)
    {
        ...
        if(type == Plant)
        {
            ...
            GameControllerFracsland.instance.ConfiscateItems(Vegetable.GetItemByVegetableType(type));
    ...
    public override void Success()
    {
        ...
        GameControllerFracsland.instance.ReturnConfiscatedItems(Vegetable.GetItemByVegetableType(Plant));
    }
