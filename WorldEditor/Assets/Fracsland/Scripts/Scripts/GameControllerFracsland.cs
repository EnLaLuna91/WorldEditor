...
/// </summary>
public class GameControllerFracsland : MonoBehaviour {

    public enum CURRENCY_TYPE {GOLD, DIAMOND };
    
	public static GameControllerFracsland instance;
    ...
    {
        GameControllerFracsland.instance.AddMoney(Mathf.RoundToInt(Mathf.Pow(1.1f, DataManager.instance.Level)) + Mathf.Max(UnityEngine.Random.Range(0, DataManager.instance.Level), 3));
    }
