...
public class DataManager : MonoBehaviour {
    ...
    public void UpdateCurrencyRequest(GameControllerFracsland.CURRENCY_TYPE currency, int ammount)
    {
        if(Constants.USE_FAKE_API)
            return;
        ...
        switch (currency)
        {
            case GameControllerFracsland.CURRENCY_TYPE.GOLD:
                url = Constants.getAPIURL(Constants.API_UPDATE_GOLD);
                break;
            case GameControllerFracsland.CURRENCY_TYPE.DIAMOND:
