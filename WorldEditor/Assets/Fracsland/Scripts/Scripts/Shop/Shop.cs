...
public class Shop : UIElement {
    ...
    public bool BuyItem(Item item, GameControllerFracsland.CURRENCY_TYPE currency, bool syncWithServer, DataManager.Callback callback)
    {
        return GameControllerFracsland.instance.BuyRequest(item, 1, currency, syncWithServer, callback);
    }
