...
namespace Quests
{
	...
	public class QuestManager : MonoBehaviour
	{
        ...
        public void GiveRewardToPlayer()
        {
            ...
            GameControllerFracsland.instance.AddDiammods(_actualQuestWithReward.NumDiamonds);
            GameControllerFracsland.instance.AddMoney(_actualQuestWithReward.NumGold);
